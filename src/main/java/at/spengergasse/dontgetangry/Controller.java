...
public class Controller {
            ...
            public void run() {
                try {
                    for (int i = 0; i < 15; i++) {
                        ...
                        File image = new File("src/main/java/at/spengergasse/dontgetangry/resource/dice" + rolledInt + ".png");
    ...
    private Parent erstelleSpielfeld() {
        ...
        int yGrid = 1;
        int id = 1;
        for (double x = Spiel.GridPadding; x < Spiel.WindowHeight; x += Spiel.TileSize + 1 * Spiel.GridPadding) {
